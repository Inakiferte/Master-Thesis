...
data_pdos = "/scratch/inakiferte/CO_on_Pt/vdW-DF/results_ph_scf1_qgrid6_final/phonon.dos"
...
ax2.text(2000, 0.2, 'IS', ha='center', va='bottom', fontsize=fontsize)
ax.text(470, 0.2, 'ES', ha='center', va='bottom', fontsize=fontsize)
...
plt.legend(fontsize=fontsize-2)
plt.savefig("dosphonons-vdW.pdf")
plt.show()
