...
file1_vdW = "/dipc/inakiferte/vdW-DF/Pt_CO_eph/Wannier/preinterpol/results_EPW_ephinterp_k12_q12_modes_1_Titemp_Lin_40_muT/results_first_modes/results_first_order_muT.dat"
file2_vdW = "/dipc/inakiferte/vdW-DF/Pt_CO_eph/Wannier/preinterpol/results_EPW_ephinterp_k12_q12_modes_1_Titemp_Lin_40_muT/results_second_modes/results_first_order_muT.dat"
file3_vdW = "/dipc/inakiferte/vdW-DF/Pt_CO_eph/Wannier/preinterpol/results_EPW_ephinterp_k12_q12_modes_1_Titemp_Lin_40_muT/temp_F_40_chosen.in"
file_40  = "/dipc/inakiferte/vdW-DF/Pt_CO_eph/Wannier/preinterpol/TTM_results/LinPRB2008/F40Jm-2/F40.dat"
file_exp = "points-Wata40-FS.dat"
file_expl = "points-Wata40-LW.dat"
...
file_waFS="Raul-Exp/watanabe-FS-40Jm2.dat"
file_waLW="Raul-Exp/watanabe-LW-40Jm2.dat"
file_inFS="Raul-Exp/inoue-FS-30-40Jm2.dat"
...
for i in range(1,half_modes_vdW+1):
 file_i1_vdW = "/dipc/inakiferte/vdW-DF/Pt_CO_eph/Wannier/preinterpol/results_EPW_ephinterp_k12_q12_modes_1_Titemp_Lin_40_muT/results_first_modes/mode%.2i.dat" %i
 value_Re1_vdW = 0
 value_Im1_vdW = 0
...
for i in range(6,half_modes_vdW+1):
  file_i2_vdW = "/dipc/inakiferte/vdW-DF/Pt_CO_eph/Wannier/preinterpol/results_EPW_ephinterp_k12_q12_modes_1_Titemp_Lin_40_muT/results_second_modes/mode%.2i.dat" %i
  value_Re2_vdW = 0
  value_Im2_vdW = 0
  for j in range(len(Te_vdW)):
...
for i in range(len(Te_vdW)):
 ...
 line_firstOr_vdW[ i ]  = -4.0*(Im_pi_firstOr_vdW[ i ] -  Im_pi_firstOr_vdW[ 0 ])
 line_secondOr_vdW[ i ] = -4.0*(Im_pi_secondOr_vdW[ i ] - Im_pi_secondOr_vdW[ 0 ])
...
#Read first order:
file1_BEEF = "/scratch/inakiferte/CO_on_Pt/BEEF-vdW/Pt_CO_eph/CO_Top/Wannier/Wannier-Bands/interpol/results_EPW_ephinterp_k12_q12_modes_1_Titemp_Lin_40_muT/results_first_modes/results_first_order_muT.dat"
file2_BEEF = "/scratch/inakiferte/CO_on_Pt/BEEF-vdW/Pt_CO_eph/CO_Top/Wannier/Wannier-Bands/interpol/results_EPW_ephinterp_k12_q12_modes_1_Titemp_Lin_40_muT/results_second_modes/results_first_order_muT.dat"
file3_BEEF = "/scratch/inakiferte/CO_on_Pt/BEEF-vdW/Pt_CO_eph/CO_Top/Wannier/Wannier-Bands/interpol/results_EPW_ephinterp_k12_q12_modes_1_Titemp_Lin_40_muT/temp_F_40_chosen.in"
...
for i in range(1,half_modes_BEEF+1):
  file_i1_BEEF = "/scratch/inakiferte/CO_on_Pt/BEEF-vdW/Pt_CO_eph/CO_Top/Wannier/Wannier-Bands/interpol/results_EPW_ephinterp_k12_q12_modes_1_Titemp_Lin_40_muT/results_first_modes/mode%.2i.dat" %i
  value_Re1_BEEF = 0
  value_Im1_BEEF = 0
...
for i in range(6,half_modes_BEEF+1):
  file_i2_BEEF = "/scratch/inakiferte/CO_on_Pt/BEEF-vdW/Pt_CO_eph/CO_Top/Wannier/Wannier-Bands/interpol/results_EPW_ephinterp_k12_q12_modes_1_Titemp_Lin_40_muT/results_second_modes/mode%.2i.dat" %i
  value_Re2_BEEF = 0
  value_Im2_BEEF = 0
  for j in range(len(Te_BEEF)):
...
for i in range(len(Te_BEEF)):
 ...
 line_firstOr_BEEF[ i ]  = -4.0*(Im_pi_firstOr_BEEF[ i ] -  Im_pi_firstOr_BEEF[ 0 ])
 line_secondOr_BEEF[ i ] = -4.0*(Im_pi_secondOr_BEEF[ i ]-Im_pi_secondOr_BEEF[ 0 ])
...
for i in range(len(Te_PBE)):
 ...
 line_firstOr_PBE[ i ]  = -4.0*(Im_pi_firstOr_PBE[ i ]-Im_pi_firstOr_PBE[ 0 ])
 line_secondOr_PBE[ i ] = -4.0*(Im_pi_secondOr_PBE[ i ]-Im_pi_secondOr_PBE[ 0 ])
...
plt.plot(time_40*10**(-3), Te_40*10**(-3), label='$T_{e}$')
plt.plot(time_40*10**(-3), Tl_40*10**(-3), label='$T_{l}$')
plt.xlim(-1.5,10)
frame2 = plt.gca()
frame2.axes.xaxis.set_ticklabels([])
#plt.legend(fontsize=fontsize-2)
plt.text(-1, 2.3, '(a)', ha='center', va='bottom', fontsize=fontsize)
...
plt.xlim(-1.5,10)
plt.legend(fontsize=fontsize-2)
plt.text(-1, 2.5, '(b)', ha='center', va='bottom', fontsize=fontsize)
frame1 = plt.gca()
...
plt.legend(fontsize=fontsize-2)
plt.xlim(-1.5,10)
plt.text(-1, -4, '(c)', ha='center', va='bottom', fontsize=fontsize)
plt.savefig('Functionals-top-Lin-40Delta.pdf')
plt.show()
