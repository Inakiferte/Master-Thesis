...
file1_vdW = "/dipc/inakiferte/vdW-DF/Pt_CO_eph/Wannier/preinterpol/results_EPW_ephinterp_k12_q12_modes_1_Titemp_Lin_130_muT/results_first_modes/results_first_order_muT.dat"
file2_vdW = "/dipc/inakiferte/vdW-DF/Pt_CO_eph/Wannier/preinterpol/results_EPW_ephinterp_k12_q12_modes_1_Titemp_Lin_130_muT/results_second_modes/results_first_order_muT.dat"
file3_vdW = "/dipc/inakiferte/vdW-DF/Pt_CO_eph/Wannier/preinterpol/results_EPW_ephinterp_k12_q12_modes_1_Titemp_Lin_130_muT/temp_F_130_chosen.in"
file_130  = "/dipc/inakiferte/vdW-DF/Pt_CO_eph/Wannier/preinterpol/TTM_results/LinPRB2008/F130Jm-2/F130.dat"
file_exp = "points-Wata130-FS.dat"
file_expl = "points-Wata130-LW.dat"
...
file_waFS="Raul-Exp/Watanabe-FS-130Jm2.dat"
file_waLW="Raul-Exp/watanabe-LW-130Jm2.dat"
file_inFS="Raul-Exp/inoue-FS-90-130Jm2.dat"
...
for i in range(1,half_modes_vdW+1):
 file_i1_vdW = "/dipc/inakiferte/vdW-DF/Pt_CO_eph/Wannier/preinterpol/results_EPW_ephinterp_k12_q12_modes_1_Titemp_Lin_130_muT/results_first_modes/mode%.2i.dat" %i
 value_Re1_vdW = 0
 value_Im1_vdW = 0
...
for i in range(4,half_modes_vdW+1):
  file_i2_vdW = "/dipc/inakiferte/vdW-DF/Pt_CO_eph/Wannier/preinterpol/results_EPW_ephinterp_k12_q12_modes_1_Titemp_Lin_130_muT/results_second_modes/mode%.2i.dat" %i
  value_Re2_vdW = 0
  value_Im2_vdW = 0
  for j in range(len(Te_vdW)):
...
#Read first order:
file1_BEEF = "/scratch/inakiferte/CO_on_Pt/BEEF-vdW/Pt_CO_eph/CO_Top/Wannier/Wannier-Bands/interpol/results_EPW_ephinterp_k12_q12_modes_1_Titemp_Lin_130_muT/results_first_modes/results_first_order_muT.dat"
file2_BEEF = "/scratch/inakiferte/CO_on_Pt/BEEF-vdW/Pt_CO_eph/CO_Top/Wannier/Wannier-Bands/interpol/results_EPW_ephinterp_k12_q12_modes_1_Titemp_Lin_130_muT/results_second_modes/results_first_order_muT.dat"
file3_BEEF = "/scratch/inakiferte/CO_on_Pt/BEEF-vdW/Pt_CO_eph/CO_Top/Wannier/Wannier-Bands/interpol/results_EPW_ephinterp_k12_q12_modes_1_Titemp_Lin_130_muT/temp_F_130_chosen.in"
...
for i in range(1,half_modes_BEEF+1):
  file_i1_BEEF = "/scratch/inakiferte/CO_on_Pt/BEEF-vdW/Pt_CO_eph/CO_Top/Wannier/Wannier-Bands/interpol/results_EPW_ephinterp_k12_q12_modes_1_Titemp_Lin_130_muT/results_first_modes/mode%.2i.dat" %i
  value_Re1_BEEF = 0
  value_Im1_BEEF = 0
...
for i in range(6,half_modes_BEEF+1):
  file_i2_BEEF = "/scratch/inakiferte/CO_on_Pt/BEEF-vdW/Pt_CO_eph/CO_Top/Wannier/Wannier-Bands/interpol/results_EPW_ephinterp_k12_q12_modes_1_Titemp_Lin_130_muT/results_second_modes/mode%.2i.dat" %i
  value_Re2_BEEF = 0
  value_Im2_BEEF = 0
  for j in range(len(Te_BEEF)):
...
file1_PBE = "/dipc/inakiferte/PBE/Pt_CO_eph/Wannier/Wannier-Bands/interpol/results_EPW_ephinterp_k12_q12_modes_1_Titemp_Lin_130_muT/results_first_modes/results_first_order_muT.dat"
file2_PBE = "/dipc/inakiferte/PBE/Pt_CO_eph/Wannier/Wannier-Bands/interpol/results_EPW_ephinterp_k12_q12_modes_1_Titemp_Lin_130_muT/results_second_modes/results_first_order_muT.dat"
file3_PBE = "/dipc/inakiferte/PBE/Pt_CO_eph/Wannier/Wannier-Bands/interpol/results_EPW_ephinterp_k12_q12_modes_1_Titemp_Lin_130_muT/temp_F_130_chosen.in"
...
for i in range(1,half_modes_PBE+1):
 file_i1_PBE = "/dipc/inakiferte/PBE/Pt_CO_eph/Wannier/Wannier-Bands/interpol/results_EPW_ephinterp_k12_q12_modes_1_Titemp_Lin_130_muT/results_first_modes/mode%.2i.dat" %i
 value_Re1_PBE = 0
 value_Im1_PBE = 0
...
for i in range(6,half_modes_PBE+1):
  file_i2_PBE = "/dipc/inakiferte/PBE/Pt_CO_eph/Wannier/Wannier-Bands/interpol/results_EPW_ephinterp_k12_q12_modes_1_Titemp_Lin_130_muT/results_second_modes/mode%.2i.dat" %i
  value_Re2_PBE = 0
  value_Im2_PBE = 0
  for j in range(len(Te_PBE)):
...
plt.plot(time_130*10**(-3), Te_130*10**(-3), label='$T_{e}$')
plt.plot(time_130*10**(-3), Tl_130*10**(-3), label='$T_{l}$')
plt.xlim(-1.5,10)
frame2 = plt.gca()
frame2.axes.xaxis.set_ticklabels([])
#plt.legend(fontsize=fontsize-2)
plt.text(-1.0, 5.0, '(a)', ha='center', va='bottom', fontsize=fontsize)

ax02=plt.subplot(grid[1])
plt.tick_params(axis='both', which='both',length=3, width=1.0,
labelsize=14, right=True,top=False, direction='out')
...
#Raul exp
#plt.plot(LWt_wa, LW_wa-LW_wa[0], color='red', label='Watanabe',
#linewidth=1,marker='s',markersize=fontsize-12)
...
plt.legend(fontsize=fontsize-2)
plt.text(-1.0, 7.5, '(b)', ha='center', va='bottom', fontsize=fontsize)
frame1 = plt.gca()
...
plt.legend(fontsize=fontsize-2)
plt.xlim(-1.5,10)
plt.text(-1.0, -15, '(c)', ha='center', va='bottom', fontsize=fontsize)

plt.savefig('Functionals-top-Lin-130Delta.pdf')
plt.show()
