...
print("Here we plot the DOS for the CO on hcp position for PBE functional")

#Read data

file_dostot = "/dipc/inakiferte/PBE/Pt_CO_relax/CO_Hcp/Pt_CO_DOS/nscf_PBE_PtCO_Hcp_12/dos_tot.dat"
file_dosd = "/dipc/inakiferte/PBE/Pt_CO_relax/CO_Hcp/Pt_CO_DOS/nscf_PBE_PtCO_Hcp_12/dos_d.dat"
file_doss = "/dipc/inakiferte/PBE/Pt_CO_relax/CO_Hcp/Pt_CO_DOS/nscf_PBE_PtCO_Hcp_12/dos_s.dat"
file_dosOs = "/dipc/inakiferte/PBE/Pt_CO_relax/CO_Hcp/Pt_CO_DOS/nscf_PBE_PtCO_Hcp_12/dos_Os.dat"
file_dosOp = "/dipc/inakiferte/PBE/Pt_CO_relax/CO_Hcp/Pt_CO_DOS/nscf_PBE_PtCO_Hcp_12/dos_Op.dat"
file_dosCs = "/dipc/inakiferte/PBE/Pt_CO_relax/CO_Hcp/Pt_CO_DOS/nscf_PBE_PtCO_Hcp_12/dos_Cs.dat"
file_dosCp = "/dipc/inakiferte/PBE/Pt_CO_relax/CO_Hcp/Pt_CO_DOS/nscf_PBE_PtCO_Hcp_12/dos_Cp.dat"
...
labelsize=15, right=True, top=True, direction='in')
plt.xticks([])
plt.plot(EnergyCp - Efermi, dosCpz + dostotCs + dosOpz + dostotOs ,label="$\sigma$ character",color="black")
plt.fill_between(EnergyCp - Efermi, 0, dosCpz + dostotCs + dosOpz +
dostotOs, where=(EnergyCp <
Efermi),
alpha=0.25, facecolor='black')

plt.plot(EnergyOp - Efermi, dosOpx + dosCpx, label="$\pi_{x}$ character",color="r" )
plt.fill_between(EnergyOp - Efermi, 0, dosOpx+dosCpx, where=(EnergyOp <Efermi),alpha=0.25, facecolor='r')
plt.plot(EnergyOp - Efermi, dosOpy+ dosCpy, label="$\pi_{y}$ character",color="blue", linestyle="dashed" )
plt.fill_between(EnergyOp - Efermi, 0, dosOpy+dosCpy, where=(EnergyOp <Efermi),alpha=0.25, facecolor='blue')
...
plt.xticks([])
#plt.ylabel("DOS(E)",fontsize=fontsize)
plt.plot(EnergySurd - EfermiSur, dosSurdz2, label="clean surface",color="green", linestyle="dashed")
...
plt.savefig('PDOS-PBEHcpSurfaceproj.pdf')
plt.show()
