...
data_pdos = "/scratch/inakiferte/CO_on_Pt/PBE/phonons/results_ph_scf1_qgrid6_final/phonon.dos"
...
ax.text(-80, 0.5, 'F($\omega$)',rotation=90, ha='center', va='bottom', fontsize=fontsize)
ax2.text(2040, 0.3, 'IS', ha='center', va='bottom', fontsize=fontsize)
ax.text(500, 0.33, 'ES', ha='center', va='bottom', fontsize=fontsize)
...
plt.legend(fontsize=fontsize-2)
plt.savefig("dosphonons-PBE.pdf")
plt.show()
